...
function TwitterIcon({ className }: IconProps): JSX.Element {
  return (
    <svg className={cn('fill-current', className)} viewBox='0 0 100 100'>
      {/* Contorno del ojo */}
      <ellipse
        cx='50'
        cy='50'
      ...
      {/* Iris */}
      <circle cx='50' cy='50' r='18' fill='currentColor' fillOpacity='0.6' />
